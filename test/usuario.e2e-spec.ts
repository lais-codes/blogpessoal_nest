...
describe('Testes dos Módulos Usuário e Auth (e2e)', () => {  // descrição do teste e2e
  ...
  it("01 - Deve criar um novo usuário", async () => { // testa se o usuário pode ser criado
    ...
    .post('/usuarios/cadastrar').send({ //envia uma requisição post para a rota /usuarios/cadastrar
      nome: "root",
    ...
    usuarioId = resposta.body.id; // salva o id do usuário criado na variável usuário
  });
  ...
  it("04 - Deve Listar todos o Usuários", async () => {
